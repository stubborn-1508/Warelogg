...
export default function ReviewForm({warehouse_id, user_id, switchForm } ) {
  ...
  const add = async () => {
    ...
    try {
      if(comment=='' || stars==0)
      {
       ...
       const res = await axios.post("/addReview", { warehouse_id, user_id, comment, stars });
    ...
    <>
      <div class="wrapper">
        <div class="master">
          ...
          <div class="container ">
            <div class="feedback shadow p-3 mb-5 bg-white rounded">
              <div class="rating ">
                <input type="radio" name="rating" id="rating-5" onChange={handleStarChange} value="5"/>
                <label for="rating-5"></label>
                <input type="radio" name="rating" id="rating-4" onChange={handleStarChange} value="4"/>
                <label for="rating-4"></label>
                <input type="radio" name="rating" id="rating-3" onChange={handleStarChange} value="3"/>
                <label for="rating-3"></label>
                <input type="radio" name="rating" id="rating-2" onChange={handleStarChange} value="2"/>
                <label for="rating-2"></label>
                <input type="radio" name="rating" id="rating-1" onChange={handleStarChange} value="1"/>
