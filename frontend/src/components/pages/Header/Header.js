        ...
        <div className="row px-xl-5">
          <div className="col-lg-3">
            <Link to="" className="text-decoration-none d-none d-lg-block">
              <h1 className="m-0" style={styles}>
                ...
                <span style={{fontSize:"30px" ,backgroundImage:"linear-gradient(60deg, #E21143, #FFB03A)",WebkitBackgroundClip:"text",color:"transparent" ,textTransform:"none"}}>Warelogg</span>
              </h1>
            </Link>
          </div>
          <div className="col-lg-9">
            <nav className="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0">
              ...
              <Link
                to="/"
                className="text-decoration-none d-block d-lg-none d-xs-none"
              >
                <h1 className="m-0">
                  {/* <span className="text-yellow">Let's </span> */}
